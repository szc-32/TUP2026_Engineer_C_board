...
MessageErrorCode Message_Center_t::PointerInit(void *msg,Msg_Type_e type)
{
	...
	switch(type)
	{
		...
		case MONITORPUB:
			...
			break;
		case LIFTINGPUB:
			lifting_msg = (Lifting_Pub_Msg_t*)msg;
			break;
		case SUCTIONPUB:
			suction_msg = (Suction_Cup_Pub_Msg_t*)msg;
			break;
		case TOTALNUM:
			break;
		default:
...
{
	return message_center.lifting_msg;
}

Suction_Cup_Pub_Msg_t *SuctionPointer()
{
	return message_center.suction_msg;
}

// Moving_Behavior_Pub_Msg_t *MovingPointer()
// {
// 	return message_center.moving_behavoir_msg;
// }
///////////////发布-订阅模式
