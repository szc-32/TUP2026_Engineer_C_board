...
CANTxInstance_t CANTxInstance[] = 
{
	...
	{&hcan2,{0x200,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //3
	{&hcan2,{0x1FF,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //4
	{&hcan2,{0x2FF,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //5
	//add more
	{&hcan1,{0x301,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //6
	{&hcan1,{0x302,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //7
	{&hcan1,{0x210,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //8:超电测试
	{&hcan1,{0x141,0,CAN_ID_STD,CAN_RTR_DATA,0x08},{&zero_current}},	 //9：9025测试
};
...
//void CANMsgCopy(uint8_t target_group,uint8_t copy_msg[8])
//{
//	for(uint8_t i = 0; i <= 7; i++)
//	{
//		CANTxInstance[target_group].set_current[i] = copy_msg[i];
//	}
//}
/**
  * @brief          发送数据地址获取
...
void MotorSendTask()
{
	...
	//CAN2 ID:1-4
	CANSendToMotor(&CANTxInstance[3],*CANTxInstance[3].set_current[0],*CANTxInstance[3].set_current[1],*CANTxInstance[3].set_current[2],*CANTxInstance[3].set_current[3]);
	//CAN2 ID:5-8
	CANSendToMotor(&CANTxInstance[4],*CANTxInstance[4].set_current[0],*CANTxInstance[4].set_current[1],*CANTxInstance[4].set_current[2],*CANTxInstance[4].set_current[3]);
}
...
void OthersSendTask()
{
	CANSendFpMessage(&CANTxInstance[6],&ChassisPointer()->send_vx_set,&ChassisPointer()->send_vy_set);
	CANSendFpMessage(&CANTxInstance[7],NULL,&ChassisPointer()->send_wz_set);
//	CANSendU8Message(&CANTxInstance[8],GetCapPointer()->send_data);
	CANSendU8Message(&CANTxInstance[9],GetLKPointer(1)->send_data);
}
