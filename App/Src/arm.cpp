...
static const fp32 g_arm_q_min_default[ARM_DOF] = {
	-3.1415926f, -0.9467733f, -1.5707963f, -1.5707963f, -1.5707963f, 0.0f
};

static const fp32 g_arm_q_max_default[ARM_DOF] = {
	3.1415926f, 1.5707963f, 1.0471976f, 1.5707963f, 1.5707963f, 3.1415926f
};
...
static const ArmDMJointMap_t g_arm_dm_map_default[ARM_DOF] = {
	...
	{1.0f, 1.0f, 0.0f, -1.5707963f, 1.0471976f, 0.0f, 40.0f, 1.0f, 0.0f},
