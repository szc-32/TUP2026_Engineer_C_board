...
//摩擦轮
#define FIRC_SPEED_PID_KP 10.13f
#define FIRC_SPEED_PID_KI 0.07f
...
//拨盘参数
#define STIR_SPEED_PID_KP 1000.0f //1000.0f //3000  2650 1400 1000
#define STIR_SPEED_PID_KI 10.0f //10.0f //0.10f
#define STIR_SPEED_PID_KD 0.0f //0.0f //20.0f
#define STIR_SPEED_PID_MAX_OUT 16384.0f
#define STIR_SPEED_PID_MAX_IOUT 5000.0f

#define STIR_POSITION_PID_KP 10.1 //15.1f //40.0f//11.1f//0.0015f//0.0008f、0.003
#define STIR_POSITION_PID_KI 0.5f//0.5f //0.010f
#define STIR_POSITION_PID_KD 0.0f //0.0f //10.0f
...
//		uint8_t  shoot_finish;						//射击完成标志位（暂时未使用）
