/**
 * @file observe_pattern.cpp
 * @brief Lightweight observer container used by legacy modules.
 */
...
{
	// Keep bounded registration to avoid dynamic allocation in embedded runtime.
	if(observe_count < 3)
	{
