/**
 * @file pub_sub_pattren.cpp
 * @brief C-compatible pub/sub wrapper backed by C++ callbacks.
 */
...
class PublisherImpl {
public:
    // Broadcast raw payload to all registered subscribers.
    ...
    // Register one callback consumer.
