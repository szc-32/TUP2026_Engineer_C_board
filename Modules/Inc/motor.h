...
#define M3508_MOTOR_RPM_TO_V 0.00551156605892946182186 
#define MOTOR_2006_RPM_TO_V  0.00290888208665721596153f  //(2*3.14)/36/60
...
class Dji_Motor_Measure_t
{
	public:
	  ...
	  int32_t output_encoder_num; //输出轴编码器圈数
...
class DJIMotorInstance
{
	...
	public:
		...
		void MonitorCurrent();//电流监测函数（电机堵转）
